...
public partial class Employee : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Session["UserID"] != null)
            {
                ...
                {
                    Security(lnkBtnNewEmp, gvEmployeeDetails);
                }
            }
        }
    }
    ...
    protected void gvEmployeeDetails_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        Label lblIbsid = (Label)gvEmployeeDetails.Rows[e.NewSelectedIndex].FindControl("lblIbsid");
    ...
    protected void txtName_TextChanged(object sender, EventArgs e)
    {
        ...
        if (txtSearch.ID.ToString() == "txtName")
            AssignTextValues(txtSearch.Text, null, null, null, null, null);
        else if (txtSearch.ID.ToString() == "txtLastName")
            AssignTextValues(null, txtSearch.Text, null, null, null, null);
        else if (txtSearch.ID.ToString() == "txtCellPhone")
            AssignTextValues(null, null, txtSearch.Text, null, null, null);
        else if (txtSearch.ID.ToString() == "txtHomePhone")
            AssignTextValues(null, null, null, txtSearch.Text, null, null);
        else if (txtSearch.ID.ToString() == "txtBusinessPhone")
            AssignTextValues(null, null, null, null, txtSearch.Text, null);
        else if (txtSearch.ID.ToString() == "txtEmailID")
            AssignTextValues(null, null, null, null, null,txtSearch.Text);
    ...
    private void AssignTextValues(string strFirstName,string strLastName,string strCellPhone,string strHomePhone,string strBusinessPhone,string strEmailID)
    {
